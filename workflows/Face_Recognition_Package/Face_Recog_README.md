...
* **Use this option to test your Collections by **(1)** creating a folder with pictures of notable people in your collections and **(2)** creating a folder with unidentified people (that contains individuals from your first folder -- we will use this method to learn to train models in the ***Advanced*** section below.**
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
###  **Option two:** Create your own directory by:
* Create a directory - The "images" directory contains subdirectories, each representing a different individual (person). Images can be in common formats like JPEG, PNG, TIFF, etc... Within each person's subdirectory, you will find multiple images of that person's face.
